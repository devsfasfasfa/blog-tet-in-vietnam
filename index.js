...
chatbox.setAttribute("page_id", "106380098638006");
...
var pictureSrc = "http://vipprao.wap.sh/holiday_tet/hoamai.png"; //the location of the snowflakes
...
for (var x = 0; x < numFlakes; x++) {
  if (document.layers) {
    ...
    document.write(
      '<div style="position:absolute;"id="snFlkDiv' +
        x +
        '"><img src="' +
        pictureSrc +
        '"height="' +
